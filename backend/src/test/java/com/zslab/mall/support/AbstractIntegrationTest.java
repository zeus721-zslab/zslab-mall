 ...
 *
 * <p><b>스케줄러 전역 비활성(Track 96-6·Track 99 자동 배송완료·Track 104-2 불일치 점검 추가)</b>: 월 정산 자동 생성·등급 재산정·자동 배송완료·불일치 점검 스케줄러는 데이터를 자동 변경·기록하므로 모든 통합 테스트
...
public abstract class AbstractIntegrationTest {
    ...
    static void datasourceProps(DynamicPropertyRegistry registry) {
        ...
        registry.add("zslab.delivery.auto-complete.enabled", () -> "false");
        registry.add("zslab.reconciliation.check.enabled", () -> "false");
    }
}
