 ...
 * 소비측(Inventory 예약·NotificationLog)은 publicId/orderId로 재조회한다. 핸들러는 후속 트랙(NotificationLog·Inventory) 진입 시 구현(D-87).
 * (CartItem 소진은 Track 67에서 PaymentCompleted 소비로 이동)
 *
