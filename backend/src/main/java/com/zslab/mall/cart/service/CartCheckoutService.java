 ...
 *
 * <p><b>빈 주문 선가드(D3)</b>: selected 품목이 0개면 {@link EmptyCartCheckoutException}(422)으로 즉시 차단해
 * OrderService ORD-1(빈 주문 불가) 도달 전 명확한 사유를 반환한다.
 */
@Service
...
public class CartCheckoutService {
     ...
     * @throws EmptyCartCheckoutException selected 품목이 0개일 때(422)
     */
