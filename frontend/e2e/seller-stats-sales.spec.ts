...
test.describe('셀러 매출 통계(90-E-1)', () => {
  test('데모 셀러 → 사이드바 통계 3항목 활성 · 요약 6 = 응답 · 차트 · 분해 행 = 응답 · 정산 링크 · 축 전환(옵션 → breakdown axis=OPTION·URL) · CSV export 200 text/csv', async ({ page }) => {
    ...
    // 사이드바: 통계 그룹 3항목 전부 링크 → 매출 클릭으로 진입
