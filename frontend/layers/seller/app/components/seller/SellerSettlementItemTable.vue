...
import type { SellerSettlementItem } from '#layers/seller/app/types/seller-settlement'
import { SELLER_SETTLEMENT_PAGE_SIZES } from '#layers/seller/app/lib/constants/seller-settlement'
import { formatCommissionRate } from '#layers/seller/app/lib/seller-settlement-view'
...
const headers = [
  ...
  { title: '주문', key: 'orderPublicId', sortable: false },
